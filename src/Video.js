...
class Video extends Component {
	...
	openCodeBoard = () => {
		//window.location = "https://www.jdoodle.com/online-java-compiler/";
		//opens a new tab with this url
		var new_window = window.open("https://www.online-ide.com/", '_blank').focus();
		alert("Click on the ScreenShare button to share the code board");
	}
				...
				{this.state.askForUsername === true ?
					...
					<div>
						<div className="btn-down" style={{ backgroundColor: "whitesmoke", color: "whitesmoke", textAlign: "center" }}>
							...
							<IconButton style={{ color: "#424242" }} onClick={this.openCodeBoard}>
									<CodeIcon />
							</IconButton>
